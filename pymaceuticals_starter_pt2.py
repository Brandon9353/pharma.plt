...
# ### Analysis
# 
# - with the data provided we can tell that Capomulin had the best results for the size of the tumor.
# - Ketapril held the held the worst results
# - with the line grah that was made we can tell that the tumor size shrank exponentially over the time of the test
# - our scatter chart show that with increse weight the tumor sizes were typically bigger
#  
